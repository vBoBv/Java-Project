...
public class ViewAndChangeCustomerDetails extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ViewAndChangeCustomerDetails frame = new ViewAndChangeCustomerDetails();
	 ...
	 * Create the frame.
	 */
	public ViewAndChangeCustomerDetails() {
		...
		lblViewDetails.setForeground(new Color(102, 102, 102));
		lblViewDetails.setFont(new Font("Times New Roman", Font.BOLD, 15));
		lblViewDetails.setBounds(0, 0, 500, 49);
		viewDetailsPanel.add(lblViewDetails);
	}
}
