...
public class ViewAndChangeGoldDetails extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ViewAndChangeGoldDetails frame = new ViewAndChangeGoldDetails();
	 ...
	 * Create the frame.
	 */
	public ViewAndChangeGoldDetails() {
		...
		JLabel lblViewGoldDetails = new JLabel("View Details");
		lblViewGoldDetails.setHorizontalAlignment(SwingConstants.CENTER);
		lblViewGoldDetails.setForeground(new Color(102, 102, 102));
		lblViewGoldDetails.setFont(new Font("Times New Roman", Font.BOLD, 15));
		lblViewGoldDetails.setBounds(0, 0, 500, 49);
		viewDetailsPanel.add(lblViewGoldDetails);
	}
}
